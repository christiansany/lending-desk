...
export function conflict(detail: string, takenUntil: string): Problem {
  return { type: PROBLEM_TYPES.conflict, title: 'Period already taken', status: 409, detail, takenUntil }
}
...
export function rateLimited(): Problem {
  return { type: PROBLEM_TYPES.rateLimit, title: 'Too many requests', status: 429, detail: 'Slow down.' }
}
